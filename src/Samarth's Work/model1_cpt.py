# ============================================================
# CPT CODE PREDICTION ONLY USING BIOCLINICALBERT
...
def main():
    ...
    print(f"Number of CPT labels: {len(mlb.classes_)}")

    tokenizer = AutoTokenizer.from_pretrained(CONFIG["pretrained_model"])

    train_dataset = CPTDataset(train_df, tokenizer, CONFIG["max_length"])
    val_dataset = CPTDataset(val_df, tokenizer, CONFIG["max_length"])
    test_dataset = CPTDataset(test_df, tokenizer, CONFIG["max_length"])
    ...
    print("Evaluating CPT model on test set...")
